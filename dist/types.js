        ...
        '39eF': [
            function(require, module, exports) {
                ...
                var e = function(n) {
                    ...
                    O = h('Object', i, Object),
                    g = h('Number', f, Number),
                    j = h('Boolean', a, Boolean),
                    T = h('Boolean', Array.isArray, Array),
                    A = {}
                ;(A[String] = m),
                    (A[Object] = O),
                    (A[Number] = g),
                    ...
                    P = function(t, r) {
                        return function(e) {
                            var u = Object.entries(t)
                                ...
                                o = e[u]
                            return o ? o(r) : l(u + ' is not in the object!')
                        }
                    },
                    z = function(t, r) {
                        return B(r)
                            ? p(k(r))
                                  ...
                                  .value()
                            : l(
                                  'Union: Type definition must consist only of functions'
                              )
                    },
                    C = h('Any', function(n) {
                        return e(n)
